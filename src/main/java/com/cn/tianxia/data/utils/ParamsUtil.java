...
import com.cn.tianxia.data.base.filter.XssHttpServletRequestWrapper;
...
public class ParamsUtil {
    ...
    public static Map<String,String> getRequestParameters(ServletRequest request) {
        ...
        while (enums.hasMoreElements()) {
            ...
            String paraValue = ParamsUtil.getRequest(request).getParameter(paraName);
    ...
    public static Map<String, String> getRequestBodyMap(ServletRequest request) {
        try {
            ...
            if (request.getAttribute(STR_BODY) != null) {
                ...
                try {
                    Map<String,String > maps = (Map<String, String>) JSONUtil.parse(request.getInputStream());
                    dataMap.putAll(maps);
    ...
    public static String getParameter(ServletRequest request, String key) {
        return ParamsUtil.getRequest(request).getParameter(key);
    }
    ...
    public static String getHeader(ServletRequest request, String key) {
        return ParamsUtil.getRequest(request).getHeader(key);
    }
    ...
    public static Map<String,String> getRequestHeaders(ServletRequest request) {
        ...
        Enumeration enums = ParamsUtil.getRequest(request).getHeaderNames();
        while (enums.hasMoreElements()) {
            String name = (String) enums.nextElement();
            String value = ParamsUtil.getRequest(request).getHeader(name);
